...
(function () {
  ...
  const T = {
    es: {
      ...
      all_denominations:    "Todas las denominaciones",
      ...
      about_body:           "Somos un emprendimiento numismático con sede en Mar del Plata, Argentina. Iniciamos nuestras actividades en 2020 y vendemos piezas a todo el país.\nRealizamos envíos a todo el país, principalmente a través de Andreani, aunque también trabajamos con otros servicios de mensajería según las necesidades de cada operación.\nNos especializamos en monedas de Estados Unidos, Argentina y Uruguay.",
    ...
    en: {
      ...
      about_body:           "We are a numismatic business based in Mar del Plata. We began operations in 2020 and sell pieces nationwide across Argentina.\nWe ship throughout the country, primarily via Andreani, although we also work with other courier services depending on the needs of each transaction.\nWe specialize in coins from United States, Argentina, and Uruguay.",
